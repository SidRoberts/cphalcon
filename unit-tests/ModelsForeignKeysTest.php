...
class ModelsForeignKeysTest extends PHPUnit_Framework_TestCase
{
	...
	public function _executeTestsNormal($di)
	{
		...
		$this->assertFalse(
			$di->get("modelsManager")->save($robotsParts)
		);
		...
		$this->assertFalse(
			$di->get("modelsManager")->delete($part)
		);
	...
	public function _executeTestsRenamed($di)
	{
		...
		$this->assertFalse(
			$di->get("modelsManager")->save($robottersDeles)
		);
		...
		$this->assertFalse(
			$di->get("modelsManager")->delete($robotter)
		);
		...
		$this->assertFalse(
			$di->get("modelsManager")->delete($dele)
		);
